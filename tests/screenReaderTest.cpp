...
TEST(ScreenReader, readIsWon_100) {
	Beginner beginner;
...
TEST(ScreenReader, isInitial_initial_125) {
...
TEST(ScreenReader, readMinefield_beginner_ingame_125) {
	...
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest = {
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, ONE },
		{ UNKNOWN, UNKNOWN, UNKNOWN, TWO,	  ONE,	   THREE,   UNKNOWN, UNKNOWN },
		{ UNKNOWN, UNKNOWN, FLAGGED, TWO,	  ONE,	   TWO,		UNKNOWN, UNKNOWN },
		{ TWO,	   FOUR,    FLAGGED, TWO,	  ONE,	   FLAGGED, TWO,	 ONE },
		{ ONE,	   TWO,     TWO,     ONE,	  ONE,	   ONE,		ONE,	 ZERO },
		{ ONE,	   FLAGGED, ONE,	 ZERO,	  ZERO,	   ZERO,	ZERO,	 ZERO },
		{ UNKNOWN, TWO,     ONE,	 ZERO,	  ZERO,    ZERO,	ZERO,	 ZERO },
		{ UNKNOWN, ZERO,    ZERO,	 ZERO,	  ZERO,    ZERO,	ZERO,	 ZERO }
	};

	EXPECT_EQ(minefield, minefieldTest);
};

TEST(ScreenReader, readMinefield_beginner_won_125) {
	Beginner beginner;
	ScreenReader scr(beginner, nullptr);

	std::string imageName = "beginner_won_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest = {
...
TEST(ScreenReader, readMinefield_intermediate_init_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "intermediate_init_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN },
...
TEST(ScreenReader, readMinefield_intermediate_ingame_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "intermediate_ingame_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN,	UNKNOWN,	UNKNOWN,	UNKNOWN },
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, UNKNOWN, UNKNOWN, UNKNOWN,	THREE,		ONE,		ONE },
		...
		{ UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, TWO,	   ZERO,	ZERO,	 ONE,	  ONE,	   ONE,		ZERO,	 ZERO,	  TWO,		UNKNOWN,	UNKNOWN,	UNKNOWN },
...
TEST(ScreenReader, readMinefield_intermediate_won_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "intermediate_won_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
...
TEST(ScreenReader, readMinefield_expert_init_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "expert_init_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
		 { UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN },
...
TEST(ScreenReader, readMinefield_expert_ingame_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "expert_ingame_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
		...
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, UNKNOWN, UNKNOWN, THREE, TWO, ZERO, ZERO, TWO, FLAGGED, THREE, TWO, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN }, 
		{ UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, FLAGGED, FOUR, TWO, FLAGGED, TWO, ONE, TWO, FOUR, FLAGGED, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN }, 
...
TEST(ScreenReader, readMinefield_expert_won_125) {
	Intermediate intermediate;
	ScreenReader scr(intermediate, nullptr);

	std::string imageName = "expert_won_125.png";
	std::vector<std::vector<Square>> minefield = scr.readMinefield(imageName, 1.25, true);
	std::vector<std::vector<Square>> minefieldTest =
	{
